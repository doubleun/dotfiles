...
setopt hist_ignore_space # for ignore command that starts with a space (for prevent storing sensitive command into the history file)
...
# Completion styling
zstyle ':completion:*' list-colors "${(s.:.)LS_COLORS}" # Add colors to auto-complete
